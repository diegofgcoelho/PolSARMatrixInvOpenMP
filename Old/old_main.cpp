...
const unsigned int  replicates = 10;
//Number of matrices in each replicate
const unsigned int N = 100000;

int main(int argc, char* argv[]){
//	numeric::testprint();
//	numeric::testCholesky();
//	numeric::testInverseLCholesky();
//	numeric::testInverseCholesky();
//	numeric::testMultiplyOperatorHermitian3x3andHermitian3x3();
//	numeric::testCopyOperator();
//	numeric::testMultiplyOperatorMatrix3x3andHermitian3x3();
//	numeric::testMultiplyOperatorHermitian3x3andMatrix3x3();
//	numeric::testDetFast();
...
//		#pragma omp parallel
		{
//			#pragma omp for
//			for(unsigned int n = 0; n < N; n = n+2){
//				bool flag;
//				numeric::Matrix3x3 tempProdInv;
//				numeric::complex detProd;
//				(matricesFast[n]*matricesFast[n+1]).computeInverseAndDetWithCheck(tempProdInv, detProd, flag);
//				detFast[n] = matricesFast[n].detFast();
//				detFast[n+1] = detProd.real()/detFast[n];
//				numeric::Hermitian3x3 tempH; tempH = tempProdInv*matricesFast[n];
//				matricesFast[n] = matricesFast[n+1]*tempProdInv;
//				matricesFast[n+1] = tempH;
//			}
			for(unsigned int n = 0; n < N; n++){
